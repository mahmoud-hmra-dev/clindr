export class routes {
  ...
  public static get deleteAccount(): string {
    return this.baseUrl + '/patients/delete-account';
  }
  ...
  public static get doctorInvoices(): string {
    return this.baseUrl + '/doctors/invoices';
  }
  ...
  public static get Hospitals(): string {
    return this.baseUrl + '/pages/hospitals';
  }
  public static get Speciality(): string {
    return this.baseUrl + '/pages/speciality';
  }
  public static get Clinic(): string {
    return this.baseUrl + '/pages/clinic';
  }
  ...
  public static get bookingPopup(): string {
    return this.baseUrl + '/patients/booking/booking-popup';
  }
  public static get booking2(): string {
    return this.baseUrl + '/patients/booking/booking2';
  }
  public static get booking(): string {
    return this.baseUrl + '/pages/booking';
  }
  ...
  public static get doctorProfile1(): string {
    return this.baseUrl + '/patients/doctor-profile';
  }
  ...
  public static get search1(): string {
    return this.baseUrl + '/patients/search-doctor/search';
  }
  ...
  public static get doctorGrid(): string {
    return this.baseUrl + '/patients/search-doctor/doctor-grid';
  }
